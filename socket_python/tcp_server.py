...
def binder(client_socket, addr):
  ...
  try:
    ...
    while True:
      ...
      img = os.path.abspath("mrst7th.jpg")

      img_bin = io.BytesIO(img)	
      
      client_socket.sendto(img_bin,('127.0.0.1', 2001))
...
server_socket.bind(('127.0.0.1', 2001))
...
#Reference: https://www.nowonbun.com/237.html [明月の開発ストーリ]